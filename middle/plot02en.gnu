...
set title "2. Deaths by year and month of the MoMo and INE"
set grid
set tmargin 3
set rmargin 6
set bmargin 3
...
set xrange [-0.5:11.5]
plot 'middle/plot02en.csv' u 2:xtic(1) ti col,\
            '' u 3:xtic(1) ti col
...
plot 'middle/plot02en.csv' u 2:xtic(1) ti col,\
            '' u 3:xtic(1) ti col
set output 'output/plot02en5.png'
set xrange [47.5:59.5]
plot 'middle/plot02en.csv' u 2:xtic(1) ti col,\
            '' u 3:xtic(1) ti col
set output 'output/plot02en6.png'
set xrange [59.5:71.5]
plot 'middle/plot02en.csv' u 2:xtic(1) ti col,\
            '' u 3:xtic(1) ti col
set output 'output/plot02en7.png'
set xrange [71.5:83.5]
plot 'middle/plot02en.csv' u 2:xtic(1) ti col,\
            '' u 3:xtic(1) ti col
set output 'output/plot02en8.png'
set xrange [83.5:95.5]
plot 'middle/plot02en.csv' u 2:xtic(1) ti col,\
            '' u 3:xtic(1) ti col
set output 'output/plot02en9.png'
