...
set timefmt '%Y-%m-%d'
set format x '%Y-%m-%d'
set xtics '2020-01-06',86400*7,'2020-11-01'
set ytic center rotate by 90
set ytics 0,500,3000
set datafile separator ';'
set output 'output/plot03en1.png'
set xrange ['2020-01-01':'2020-03-01']
plot 'middle/plot03en.csv' u 1:3 w lp lc 2 pt 2 ti col, '' u 1:4 w lp lc 3 pt 3 ti col, '' u 1:6 w l lc 9 ti col
set output 'output/plot03en2.png'
set xrange ['2020-03-01':'2020-05-01']
plot 'middle/plot03en.csv' u 1:2 w lp lc 1 pt 1 ti col, '' u 1:3 w lp lc 2 pt 2 ti col, '' u 1:4 w lp lc 3 pt 3 ti col, '' u 1:6 w l lc 9 ti col
set output 'output/plot03en3.png'
set xrange ['2020-05-01':'2020-07-01']
plot 'middle/plot03en.csv' u 1:3 w lp lc 2 pt 2 ti col, '' u 1:4 w lp lc 3 pt 3 ti col, '' u 1:5 w lp lc 4 pt 4 ti col, '' u 1:6 w l lc 9 ti col
