...
set xrange [-0.5:11.5]
plot 'middle/plot04en.csv' u 6:xtic(1) ti col, '' u 7:xtic(1) ti col, '' u 8:xtic(1) ti col, '' u 9:xtic(1) ti col
set output 'output/plot04en3.png'
set xrange [-0.5:11.5]
plot 'middle/plot04en.csv' u 10:xtic(1) ti col, '' u 11:xtic(1) ti col, '' u 12:xtic(1) ti col, '' u 13:xtic(1) ti col
