...
set multiplot layout 2,1 title "1. Defuncions per any i mes (només anys on algun mes ha superat els 40k morts, les dades de l'any 2020 són del MoMo i la resta són del INE)"
set rmargin 3
set grid
set auto x
set yrange [0:60000]
