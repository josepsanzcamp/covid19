...
plot 'middle/plot20ca.csv' u 1:2:xtic(1) w lp ti col,'' u 1:3 w lp ti col,'' u 1:4 w lp ti col,'' u 1:5 w lp ti col,'' u 1:6 w lp ti col
set key at '2019-01-01',130000
set xrange ['2016-01-01':'2019-01-01']
set output 'output/plot20ca2.png'
plot 'middle/plot20ca.csv' u 1:5:xtic(1) w lp ti col,'' u 1:6 w lp ti col,'' u 1:7 w lp ti col,'' u 1:8 w lp ti col,'' u 1:9 w lp ti col
set key at '2022-01-01',130000
set xrange ['2019-01-01':'2022-01-01']
set output 'output/plot20ca3.png'
plot 'middle/plot20ca.csv' u 1:8:xtic(1) w lp ti col,'' u 1:9 w lp ti col,'' u 1:10 w lp ti col,'' u 1:11 w lp ti col,'' u 1:12 w lp ti col
