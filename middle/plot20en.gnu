...
plot 'middle/plot20en.csv' u 1:11:xtic(1) w lp ti col,\
            '' u 1:12 w lp ti col,\
            '' u 1:13 w lp ti col,\
            '' u 1:14 w lp ti col
...
plot 'middle/plot20en.csv' u 1:8:xtic(1) w lp ti col,\
            '' u 1:9 w lp ti col,\
            '' u 1:10 w lp ti col,\
            '' u 1:11 w lp ti col,\
            '' u 1:12 w lp ti col,\
...
plot 'middle/plot20en.csv' u 1:5:xtic(1) w lp ti col,\
            '' u 1:6 w lp ti col,\
            '' u 1:7 w lp ti col,\
            '' u 1:8 w lp ti col,\
            '' u 1:9 w lp ti col,\
...
set output 'output/plot20en4.png'
plot 'middle/plot20en.csv' u 1:2:xtic(1) w lp ti col,\
            '' u 1:3 w lp ti col,\
            '' u 1:4 w lp ti col,\
            '' u 1:5 w lp ti col,\
            '' u 1:6 w lp ti col,\
