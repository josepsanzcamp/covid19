...
plot [-0.5:14.5] 'middle/plot2en.csv' using 2:xtic(1) ti col, '' u 3:xtic(1) ti col, '' u 4:xtic(1) ti col
plot [14.5:29.5] 'middle/plot2en.csv' using 2:xtic(1) ti col, '' u 3:xtic(1) ti col, '' u 4:xtic(1) ti col
unset multiplot
