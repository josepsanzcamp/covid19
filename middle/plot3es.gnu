...
plot ['2020-01-01':'2020-03-01'] 'middle/plot3es.csv' using 1:2 w l ti col
plot ['2020-03-01':'2020-05-01'] 'middle/plot3es.csv' using 1:2 w l ti col, '' using 1:3 w l ti col
plot ['2020-05-01':'2020-07-01'] 'middle/plot3es.csv' using 1:2 w l ti col
unset multiplot
