...
plot [-0.5:13.5] 'middle/plot8en.csv' u 2:xtic(1) ti col, '' u 3:xtic(1) ti col, '' u 4:xtic(1) ti col, '' u 5:xtic(1) ti col
plot [13.5:27.5] 'middle/plot8en.csv' u 2:xtic(1) ti col, '' u 3:xtic(1) ti col, '' u 4:xtic(1) ti col, '' u 5:xtic(1) ti col
set label 1 "Atencion: this plot has a different scale related to the previous plot of the same group" at 12,1750 c tc lt 1
set yrange [0:2000]
plot [1.5:22.5] 'middle/plot8en.csv' u 6:xtic(1) ti col, '' u 7:xtic(1) ti col, '' u 8:xtic(1) ti col
unset multiplot
