...
if (!file_exists("middle/component.csv")) {
    ...
    $matrix = array();
    if (!isset($json["pooled"]["weeks"])) {
        $json["pooled"]["weeks"] = $json["weeks"];
    }
    ...
    if (!isset($json["countries"]["countries"])) {
        $json["countries"]["countries"] = $json["countries"];
    }
    if (!isset($json["countries"]["weeks"])) {
        $json["countries"]["weeks"] = $json["weeks"];
    }
