...
if (!file_exists("index.${lang}.html")) {
    ...
    $template = str_replace(
        array("img/","css/","js/"),
        array("template/img/","template/css/","template/js/"),
        $template
    );
    $template = explode("<!-- ROWROWROW -->", $template);
    $html = str_replace(
        array("__TITLE__","__ABOUT__","__FOOTER__","__LANG__","__MOMOOLD__","__MOMOOLD2__","__MOMOOLD3__"),
        array($textos["title"][$lang],$textos["about"][$lang],$textos["footer"][$lang],
            $textos["lang"][$lang],$textos["momoold"][$lang],$textos["momoold2"][$lang],$textos["momoold3"][$lang]),
        $template[0]
    );
