...
if (!file_exists("middle/datanew-nacional-per-any.csv")) {
    console_debug("middle/datanew-nacional-per-any.csv");
    ...
    export_file("middle/datanew-nacional-per-any.csv", $sumas);
    unset($data);
    unset($sumas);
    console_debug();
}
