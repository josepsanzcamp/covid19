...
if (!file_exists("middle/dataold-nacional-per-any.csv")) {
    console_debug("middle/dataold-nacional-per-any.csv");
    ...
    export_file("middle/dataold-nacional-per-any.csv", $sumas);
    unset($data);
    unset($sumas);
    console_debug();
}
