...
if(!file_exists("output/plot01${lang}1.png")) {
	...
	$matrix=array();
	$years=array(2021,"MoMoOld",2020,2019,2018,2017,2015,2014,2012,2009,2005,2000,1999);
	...
	$gnuplot=implode("\n",array(
		...
		"set xrange [-0.5:5.5]",
		"plot 'middle/plot01${lang}.csv' u 2:xtic(1) ti col, '' u 3:xtic(1) ti col, '' u 4:xtic(1) ti col, '' u 5:xtic(1) ti col, '' u 6:xtic(1) ti col, '' u 7:xtic(1) ti col, '' u 8:xtic(1) ti col, '' u 9:xtic(1) ti col, '' u 10:xtic(1) ti col, '' u 11:xtic(1) ti col, '' u 12:xtic(1) ti col, '' u 13:xtic(1) ti col, '' u 14:xtic(1) ti col",
