...
if(!file_exists("output/plot03${lang}1.png")) {
	...
	$gnuplot=implode("\n",array(
		...
		"plot 'middle/plot03${lang}.csv' u 1:2 w lp lc 1 pt 1 ti col, '' u 1:3 w lp lc 2 pt 2 ti col, '' u 1:4 w lp lc 3 pt 3 ti col, '' u 1:6 w l lc 6 ti col",
		"set output 'output/plot03${lang}3.png'",
		"set xrange ['2020-05-01':'2020-07-01']",
		"plot 'middle/plot03${lang}.csv' u 1:3 w lp lc 2 pt 2 ti col, '' u 1:4 w lp lc 3 pt 3 ti col, '' u 1:5 w lp lc 4 pt 4 ti col, '' u 1:6 w l lc 6 ti col",
