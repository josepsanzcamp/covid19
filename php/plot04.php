...
if (!file_exists("output/plot04${lang}1.png")) {
    ...
    $matrix = array();
    $years = array("INE2018","INE2019","MoMo2020","MoMo2021","MoMo2022","MoMo2023");
    ...
    $gnuplot = implode("\n", array(
        ...
        "set xrange [-0.5:11.5]",
        "plot 'middle/plot04${lang}.csv' u 8:xtic(1) ti col,\
            '' u 9:xtic(1) ti col,\
            '' u 10:xtic(1) ti col,\
            '' u 11:xtic(1) ti col,\
            '' u 12:xtic(1) ti col,\
        ...
        "set xrange [-0.5:11.5]",
        "plot 'middle/plot04${lang}.csv' u 14:xtic(1) ti col,\
            '' u 15:xtic(1) ti col,\
            '' u 16:xtic(1) ti col,\
            '' u 17:xtic(1) ti col,\
            '' u 18:xtic(1) ti col,\
