...
if (!file_exists("output/plot14${lang}.png")) {
    ...
    // L'ARRAY DE SORTIDA TINDRA 12 ELEMENTS QUE SON ELS SUMATORIS DELS MESOS DE L'ANY + ANY ANTERIOR PER LA POSICIO
    // PER EXEMPLE:
    ...
    $gnuplot = implode("\n", array(
        ...
        "plot 'middle/plot14${lang}.csv' u 1:2 w lp ti col,\
            '' u 1:3 w lp ti col,\
            '' u 1:4 w lp ti col,\
            '' u 1:5 w lp ti col,\
            '' u 1:6 w lp ti col,\
