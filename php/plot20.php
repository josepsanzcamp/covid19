...
if (!file_exists("output/plot20${lang}1.png")) {
    ...
    foreach ($indef as $key => $val) {
        if (in_array($val[0], array("Fecha",2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023))) {
    ...
    $gnuplot = implode("\n", array(
        ...
        "plot 'middle/plot20${lang}.csv' u 1:11:xtic(1) w lp ti col,\
            '' u 1:12 w lp ti col,\
            '' u 1:13 w lp ti col,\
            '' u 1:14 w lp ti col,\
            '' u 1:15 w lp ti col",
        ...
        "set output 'output/plot20${lang}4.png'",
